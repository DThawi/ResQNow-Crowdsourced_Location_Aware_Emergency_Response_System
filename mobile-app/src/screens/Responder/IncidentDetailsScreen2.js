            ...
            <View className="flex-1 bg-[#F7F7F7]">
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
                    ...
                    <View className="mx-4 mb-6 bg-white rounded-2xl p-5 shadow-sm">
                        <View className="flex-row justify-between items-center mb-2">
                            ...
                            <View className="border border-[#003049] rounded-full px-3 py-1">
                                <Text className="text-[#003049] text-xs font-semibold">Assigned</Text>
                            </View>
                        </View>
                    ...
                    <View className="mx-4 mb-6">
                        <TouchableOpacity className="bg-[#D62828] py-3.5 rounded-xl items-center flex-row justify-center mb-3 shadow-md">
